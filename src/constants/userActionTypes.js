...
export const USER_IS_LOGIN_FAIL_SET   = 'USER_IS_LOGIN_FAIL_SET'
export const USER_IS_LOGOUT_FAIL_SET  = 'USER_IS_LOGOUT_FAIL_SET'
export const USER_IS_PROFILE_FAIL_SET = 'USER_IS_PROFILE_FAIL_SET'
